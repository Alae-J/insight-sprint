...
public class SecurityConfig {
    ...
    @Bean
    public AuthenticationManager authenticationManager(HttpSecurity http, PasswordEncoder passwordEncoder, AuthService authService) throws Exception {
        // Link the authentication manager to our custom UserDetailsService and encoder
        return http.getSharedObject(AuthenticationManagerBuilder.class)
                .userDetailsService(authService) // tells Spring where to fetch user info from
